...
from Ruleta_Europea.movimiento_ruleta import *
from Ruleta_Europea.ganar import *
...
def ejecutar_ruleta():
    ...
    def key_recorder(key):
        ...
        #Apostar con la ficha de 5
            ...
            if dinero > 0 and dinero >= 5:
                ...
                ficha = vlc.MediaPlayer("./Ruleta_Europea/musica/fichas_poker2.mp3")
        ...
        #         d_fichas[b_posicion()] = ""
            ...
            ficha = vlc.MediaPlayer("./Ruleta_Europea/musica/clic.mp3")
            ...
            if t_apuesta > 0 :
                ...
                ficha = vlc.MediaPlayer("./Ruleta_Europea/musica/devolucion.mp3")
    ...
    def fichas_apuesta():
        ...
        if premio > 0:
            ...
            g_img() 
            ficha = vlc.MediaPlayer("./Ruleta_Europea/musica/victoria.mp3")
            ficha.audio_set_volume(80)
            ficha.play()
            sleep(2.5)
        else:
            p_img()
            ficha = vlc.MediaPlayer("./Ruleta_Europea/musica/perder1.1.mp3")
            ficha.audio_set_volume(80)
            ficha.play()
            sleep(4)
